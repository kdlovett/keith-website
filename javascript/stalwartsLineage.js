...
function boatMove(e) {
    switch(e.keyCode) {
        ...
        case 70:
            if (canRaise == 1){
                //Raising apple.
                lawrence.image.src = "/keiths-site/images/stalwartSprites/farmer_raiseArm.gif";
                canRaise = 0;
                appleRaised = 1;
        ...
        case 69:
            if (canCatch == 1){
                //Closing arms.
                iris.image.src = "/keiths-site/images/stalwartSprites/lady2grab.gif";
                canCatch = 0;
                armsRaised = 1;
...
function moorlordAxeToss(){
    ...
    moorlord.image.src = "/keiths-site/images/stalwartSprites/moorlordAttack.gif";
    ...
    if (moorlordAxeThrows > 0) {
        ...
        boatHealth -= 10;
        moorlord.image.src = "/keiths-site/images/stalwartSprites/moorlord.gif";
...
function moorlordMoveRight() {
    ...
    moorlordPhantasm.x = -30;
    moorlordPhantasm.y = 245;
    moorlord.image.src = "/keiths-site/images/stalwartSprites/moorlord_cast.gif";
    moorlordMovement = 1;
    moorlord.x = 80;
    moorlord.y = 200;
...
function irisTurnReload() {
    ...
    if (iris.image.src != "/keiths-site/images/stalwartSprites/lady2grab.gif"){
        if (irisTurn == 0){
            iris.image.src = "/keiths-site/images/stalwartSprites/lady2.gif";
            irisTurn = 1;
        } else {
            iris.image.src = "/keiths-site/images/stalwartSprites/lady.gif";
            irisTurn = 0;
        }
    }
...
function skullFlapReload() {
    ...
    if (skullFlap == 0) {
        skull.image.src = "/keiths-site/images/stalwartSprites/FloatingSkull1.gif"
        skullFlap = 1;
    } else {
        skull.image.src = "/keiths-site/images/stalwartSprites/FloatingSkull2.gif"
        skullFlap = 0;
    }
    setTimeout(skullFlapReload, 300);
}
...
function appleWait() {
    ...
    lawrence.image.src = "/keiths-site/images/stalwartSprites/farmer.gif";
    appleRaised = 0;
...
function createEnvironment(){
    ...
    moon = new component(61, 61, "/keiths-site/images/stalwartSprites/moon.gif", 320, 50, "image");
    mountain1 = new component(300,200, "/keiths-site/images/stalwartSprites/mountain1.gif", 380, 140, "image");
    mountain2 = new component(300,150, "/keiths-site/images/stalwartSprites/mountain2.gif", 680, 140, "image");
    mountain3 = new component(300,250, "/keiths-site/images/stalwartSprites/mountain3.gif", 100, 140, "image");
    mountain4 = new component(150,125, "/keiths-site/images/stalwartSprites/mountain3.gif", 180, 160, "image");
    mountain5 = new component(150,75, "/keiths-site/images/stalwartSprites/mountain2.gif", 400, 180, "image");
    mountain6 = new component(150,100, "/keiths-site/images/stalwartSprites/mountain1.gif", 650, 160, "image");
    bogTree1 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 100, 150, "image");
    bogTree2 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 200, 155, "image");
    bogTree3 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 300, 153, "image");
    bogTree4 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 400, 152, "image");
    bogTree5 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 500, 151, "image");
    bogTree6 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 600, 154, "image");
    bogTree7 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 700, 155, "image");
    bogTree8 = new component(135,220, "/keiths-site/images/stalwartSprites/bog_tree.gif", 800, 156, "image");
    ...
    reeds1 = new component(300, 32, "/keiths-site/images/stalwartSprites/reeds.gif", 230, 222, "image");
    reeds2 = new component(300, 32, "/keiths-site/images/stalwartSprites/reeds.gif", 520, 220, "image");
    reeds3 = new component(300, 32, "/keiths-site/images/stalwartSprites/reeds.gif", 810, 225, "image");
    reeds4 = new component(300, 32, "/keiths-site/images/stalwartSprites/reeds.gif", 1100, 224, "image");
    reeds5 = new component(300, 32, "/keiths-site/images/stalwartSprites/reeds.gif", 1400, 223, "image");
    sky = new component(640, 300, "#3a207e", 320, 150, "shape");
    stars = new component(640, 200, "/keiths-site/images/stalwartSprites/stars.gif", 320, 100, "image");
    forest1 = new component(160, 40, "/keiths-site/images/stalwartSprites/forest.gif", 320, 180, "image");
    forest2 = new component(160, 40, "/keiths-site/images/stalwartSprites/forest.gif", 600, 170, "image");
    forest3 = new component(160, 40, "/keiths-site/images/stalwartSprites/forest.gif", 100, 170, "image");
    boatwave1 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 450,270, "image");
    boatwave2 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 450,275, "image");
    boatwave3 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 400,270, "image");
    boatwave4 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 400,275, "image");
    boatwave5 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 350,270, "image");
    boatwave6 = new component(32,32, "/keiths-site/images/stalwartSprites/boatwave.gif", 350,275, "image");
    passage = new component(74,67, "/keiths-site/images/stalwartSprites/passage.gif", 800,185, "image");
    blackScreen = new component(640, 350, "#000000", 320, 175, "shape");
}

function createCharacters(){
    //Creating components of characters.
    moorlord = new component(43, 63, "/keiths-site/images/stalwartSprites/moorlord.gif", 0,-30, "image");
    moorlordAxe = new component(15, 30, "/keiths-site/images/stalwartSprites/moorlordAxe.gif", 0, -30, "image");
    moorlordPhantasm = new component(27, 62, "/keiths-site/images/stalwartSprites/moorlord_teleport.gif", -30, 245, "image");
    stalwart = new component(38, 48, "/keiths-site/images/stalwartSprites/stalwartFaceLeft.gif", 255,245, "image");
    javert = new component(21,50, "/keiths-site/images/stalwartSprites/old_man.gif", 365,245, "image");
    iris = new component(50,50, "/keiths-site/images/stalwartSprites/lady.gif", 340,190, "image");
    lawrence = new component(16, 43, "/keiths-site/images/stalwartSprites/farmer.gif", 402,247, "image");
    huron = new component(97,60, "/keiths-site/images/stalwartSprites/eagle.gif", 700,120, "image");
    wretched = new component(65,68,"/keiths-site/images/stalwartSprites/armoredWretchFloat.gif", 900, 220, "image");
    skull = new component(25,18,"/keiths-site/images/stalwartSprites/FloatingSkull1.gif", 900, 190, "image");
}

function createBoat(){
    //Creating components of boat.
    boat = new component(240, 71, "/keiths-site/images/stalwartSprites/boatFinal.gif", 340, 240, "image");
    wheel = new component(102, 102, "/keiths-site/images/stalwartSprites/wheelFinal.gif", 315, 240, "image");
    cannon = new component(30,30, "/keiths-site/images/stalwartSprites/cannon.gif", 243,242, "image");
    cannonBall = new component(4,4, "/keiths-site/images/stalwartSprites/cannonBall.gif", 100,100, "image");
}
...
function updateBoat() {
    ...
    if (cannon.angle <= Math.PI) {
        stalwart.x = 255;
        stalwart.image.src = "/keiths-site/images/stalwartSprites/stalwartFaceLeft.gif";
    } else {
        stalwart.x = 235;
        stalwart.image.src = "/keiths-site/images/stalwartSprites/stalwartFaceRight.gif";
    }
    cannon.update();
...
function updateFont() {
    ...
    if (lawrenceText == 1) {
        ...
        animFrame.context.strokeText("The more you hits you get, the more distance between us and the Moorlord.",lawrence.x,lawrence.y - 25);
    }
...
function updateAnimFrame() {
    ...
    if (boatHealth > 0 && win != 1 && gameStart == 0){
        ...
        animFrame.context.strokeText("...Master sailer JAVERT, along with the knowledgable treasure hunter IRIS...",320,100);
